    ...
    <div class="grid-container">
      <div v-for="restaurante in restaurantes" :key="restaurante.id" class=" w-60 text-primary border border-gray-200 rounded-lg shadow dark:bg-gray-950 dark:border-gray-700">
        ...
        <div class="p-5">
          ...
          <router-link
            :to="{ name: 'reserva', params: { id: restaurante.id } }"
            class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-secondary bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-primary dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Fazer Reserva
